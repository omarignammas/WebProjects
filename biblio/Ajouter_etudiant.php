...
<body>
    <div class="container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <h2>Formulaire d'ajout d'un etudiant:</h2>

            <label for="num_apg">Numero d'apogee</label>
            <input type="number" name="num_apg" placeholder="Entrer numero d'apogee" required>

            
            <label for="nom">Nom d'etudiant</label>
            <input type="text" name="nom" placeholder="Entrer votre nom" required>

            <label for="prenom">Prenom d'etudiant</label>
...
$ph_photo=$nom_photo;
    ...
    $ph_photo=".png";
        ...
        <?php
        if(isset($_POST['sub'])){
            $query = "INSERT INTO `etudiant` (`num_apogee`, `nom`, `prenom`,`image`) VALUES
            ($num_apogee,'$nom','$prenom','$ph_photo')";
